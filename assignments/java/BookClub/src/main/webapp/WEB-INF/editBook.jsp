...
<body>
    ...
    <!-- MAIN -->
    <main class="m-2 w-75">
        <form:form action="/books/${book.id}/edit" method="post" modelAttribute="modelForm" class="d-flex flex-column">  
            ...
            <form:errors path="title" class="text-warning"/>
                ...
                <div class="d-flex flex-row justify-content-between my-2">
                    ...
                    <input type="text" name="title" value="${book.title}" class="w-75">
                </div>
            ...
            <form:errors path="author" class="text-warning"/>
                ...
                <div class="d-flex flex-row justify-content-between my-2">
                    ...
                    <input type="text" name="author" value="${book.author}" class="w-75">
                </div>
            ...
            <form:errors path="thoughts" class="text-warning"/>
                ...
                <div class="d-flex flex-row justify-content-between my-2">
                    ...
                    <textarea name="thoughts"class="w-75">${book.thoughts}
                    </textarea>
                </div>
